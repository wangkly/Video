...
public class VideoHelper implements IVLCVout.OnNewVideoLayoutListener {
    ...
    private ScaleType mCurrentScaleType = ScaleType.SURFACE_BEST_FIT;
    ...
    public VideoHelper(MediaPlayer player, VLCVideoLayout surfaceFrame, boolean subtitles, boolean textureView) {
        init(player, surfaceFrame, subtitles, !textureView);
    }

    private void init(MediaPlayer player, VLCVideoLayout surfaceFrame,  boolean subtitles, boolean useSurfaceView) {
        mMediaPlayer = player;
    ...
    private void changeMediaPlayerLayout(int displayW, int displayH) {
        ...
        switch (mCurrentScaleType) {
            ...
            case SURFACE_FILL: {
                ...
                if (mCurrentScaleType == ScaleType.SURFACE_FIT_SCREEN) {
...
//        }
    ...
    public  void setVideoScale(ScaleType type) {
